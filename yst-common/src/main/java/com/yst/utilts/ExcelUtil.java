...
public class ExcelUtil {
    ...
    private static OutputStream getOutputStream(String fileName, HttpServletResponse response) {
        ...
        try {
            ...
            throw new GuliException(500,"导出异常！",e);
        }
    }
    ...
    private static ExcelReader getReader(MultipartFile excel, ExcelListener excelListener) {
        ...
        if (filename == null || (!filename.toLowerCase().endsWith(".xls") && !filename.toLowerCase().endsWith(".xlsx"))) {
            throw new GuliException(500,"文件格式错误！",null);
        }
    ...
    public static ExcelTypeEnum valueOf(InputStream inputStream) {
        try {
            ...
            throw new GuliException(500,"excelTypeEnum can not null",null);
